// accel — the acceleration-structure pipeline (sort → build → traverse), gated on both the subgroup and
// the LDS-fallback builder arms every run, not whichever one this device happens to take.
import {
    AmbientLight,
    arrow,
    box,
