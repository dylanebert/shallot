// backend — the substrate swap gate: behavioural parity under either backend, never bit-exact, because
// two solvers cannot hash-match a trajectory.
import {
    AmbientLight,
    Body,
    Camera,
...
} from "../../../packages/shallot/tests/avbd/backend-geometry";
