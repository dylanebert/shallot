// mesh-fixture — the final-compositor hardening fixture: a custom-registered surface and a Part entity on
// the built-in `unlit` surface, both drawn through the real part/render/sear pipeline.
// mesh-fixture — the release-prerequisite hardening fixture: a deterministic
