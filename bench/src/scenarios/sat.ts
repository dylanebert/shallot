// sat — the validation-only GPU-SAT codegen gate the f64 oracle cannot reach: the C++ gold configs and
// the hull/rounded narrowphase matrix against byte-exact readback.
import {
    AmbientLight,
    Body,
    Camera,
