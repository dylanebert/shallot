// motor — the angular motor constraint: the motor drive HOLDS its target ω under load where the
// forced-velocity drive stalls, which is the contrast the scenario exists to draw.
import {
    AmbientLight,
    Body,
    Camera,
