...
//
// Usage: bun run scripts/build-physics-kernel.ts
...
emit(
    ...
    `// Generated by scripts/build-physics-kernel.ts from rust/physics/ — do not edit. Regenerate: bun run scripts/build-physics-kernel.ts
