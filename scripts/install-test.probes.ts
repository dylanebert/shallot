...
//
// The first command freezes the landed invocation's wrong-boundary red: Linux's system-webview refusal
// wins before the missing-crate diagnostic. The second changes only this test invocation to --portable,
// which admits the intended guard without compiling a native shell. The hidden crate is restored in a
// finally block and its complete path/byte digest is compared after restoration.
