...
import type { Node } from "../packages/shallot-runtime/src";
...
const {
    ...
    AnimationPlugin,
    AudioPlugin,
} = await import("../packages/shallot-runtime/src");
const { register } = await import("../packages/shallot-runtime/src/engine/ecs/core");
const { normalizeAttr } = await import("../packages/shallot-runtime/src/engine/scene/core");
