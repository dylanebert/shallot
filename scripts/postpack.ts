// Remove the tarball-only outputs prepack.ts / tooling.ts generated: the examples projection and the
// compiled tooling exports (dist/vite.js, dist/harness-browser.js). Both ship in the tarball but are
// gitignored and regenerated on every pack, so neither belongs in the working tree — leaving the
