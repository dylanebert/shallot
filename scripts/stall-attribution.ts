import { harnessBucketNames, type LoAFEntry } from "../packages/shallot-cli/bin/verify";
...
async function main(): Promise<void> {
    ...
    // the UA assertion below makes that launch choice observable rather than inferred from a default. This arm reads the
