 ...
 * so the real-device measurement (`bench/src/scenarios/cells.ts`'s `assertFacadeInk`) reads the
 ...
 * {@link fillIndexForLuma}'s device caller (`bench/src/scenarios/cells.ts`'s `assertFacadeInk`)
