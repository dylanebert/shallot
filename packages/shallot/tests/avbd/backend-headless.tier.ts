...
// Trigger cone: this file, `backend-geometry.ts` beside it, and the published physics
// substrate/backend modules it imports. Run from the shallot root with
// `bun test ./packages/shallot/tests/avbd/backend-headless.tier.ts`. The verdict derives its settle and no-fall-through bands from the
