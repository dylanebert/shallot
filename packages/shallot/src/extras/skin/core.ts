...
// itself, the two preamble chunks, and the bindings they name. A surface owning a material path composes
...
export { LIVE_SKIN_VS, LIVE_TINT_WGSL, SKIN_PARAMS_WGSL, skinBindings } from "./live";
