...
import goldJsonBodyType from "./tumble/samples/bodies-body-type.json";
import goldJsonMotionLocks from "./tumble/samples/bodies-motion-locks.json";
import goldJsonSpinningBook from "./tumble/samples/bodies-spinning-book.json";
import goldJsonCharacterMover from "./tumble/samples/character-mover.json";
import goldJsonOverlapBox from "./tumble/samples/collision-overlap-box.json";
import goldJsonRayCurtain from "./tumble/samples/collision-ray-curtain.json";
import goldJsonShapeCast from "./tumble/samples/collision-shape-cast.json";
import goldJsonCompoundSimple from "./tumble/samples/compound-simple.json";
import goldJsonCompoundSpheres from "./tumble/samples/compound-spheres.json";
import goldJsonTileFloor from "./tumble/samples/compound-tile-floor.json";
import goldJsonBulletVsStack from "./tumble/samples/continuous-bullet-vs-stack.json";
import goldJsonThinWall from "./tumble/samples/continuous-thin-wall.json";
import goldJsonFallingRagdolls from "./tumble/samples/determinism-falling-ragdolls.json";
import goldJsonHitEvents from "./tumble/samples/events-hit.json";
import goldJsonJointBreak from "./tumble/samples/events-joint-break.json";
import goldJsonSensorSweep from "./tumble/samples/events-sensor-sweep.json";
import goldJsonConvexHull from "./tumble/samples/geometry-convex-hull.json";
import goldJsonConvexPrimitives from "./tumble/samples/geometry-convex-primitives.json";
import goldJsonHullReduction from "./tumble/samples/geometry-hull-reduction.json";
import goldJsonBridge from "./tumble/samples/joints-bridge.json";
import goldJsonCantilever from "./tumble/samples/joints-cantilever.json";
import goldJsonDriving from "./tumble/samples/joints-driving.json";
import goldJsonElevator from "./tumble/samples/joints-elevator.json";
import goldJsonFilter from "./tumble/samples/joints-filter.json";
import goldJsonPaddle from "./tumble/samples/joints-paddle.json";
import goldJsonParallel from "./tumble/samples/joints-parallel.json";
import goldJsonPendulum from "./tumble/samples/joints-pendulum.json";
import goldJsonRope from "./tumble/samples/joints-rope.json";
import goldJsonSuspension from "./tumble/samples/joints-suspension.json";
import goldJsonTerrain from "./tumble/samples/mesh-terrain.json";
import goldJsonTorus from "./tumble/samples/mesh-torus.json";
import goldJsonRagdoll from "./tumble/samples/ragdoll-ragdoll.json";
import goldJsonInclinedPlane from "./tumble/samples/shapes-inclined-plane.json";
import goldJsonRestitution from "./tumble/samples/shapes-restitution.json";
import goldJsonShapeSoup from "./tumble/samples/shapes-shape-soup.json";
import goldJsonArch from "./tumble/samples/stacking-arch.json";
import goldJsonBoxPyramid from "./tumble/samples/stacking-box-pyramid.json";
import goldJsonDominoes from "./tumble/samples/stacking-dominoes.json";
