...
// mint used (`packages/shallot-tumble/scripts/gen-tumble-sample-golds.ts`), making registry order irrelevant to every verdict.
//
...
// a queue agent needs. Not shipped surface: this package's tests are unpublished, so it stays under tests/.
