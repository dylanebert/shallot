...
//
// In the default `bun run test` (the `test` script's explicit paths include `packages/shallot-tumble`), or
// alone:
//   bun test ./packages/shallot-tumble/tests/tumble-golds.test.ts
