...
// readback, which stalls the pipeline and would skew any profiler frame timing measured alongside it. Passive hooks cost nothing idle, so they install unconditionally.
//
