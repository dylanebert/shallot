...
| --- | --- | --- |
| `ascii` | I want my scene drawn as ASCII characters. (check: integration) | `bunx shallot add ascii` |
| `custom-material` | I want to write my own shader for a material and for the background. (check: integration) | `bunx shallot add custom-material` |
...
| `particles` | I want to simulate and draw many particles on the GPU. (check: integration) | `bunx shallot add particles` |
