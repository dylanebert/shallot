...
//
// This is the substrate's own joint surface. Motors, limits, and physics's richer joint types (prismatic,
// wheel, cone/twist) live past it on the `Physics.world` escape hatch — verified in the gym twins
