// joints-pendulum — stage-4 gym twin (spec tumble-inline stage 4): the tumble.js `Pendulum` sample
...
import goldJson from "../../../../packages/shallot/tests/tumble/samples/joints-pendulum.json";
