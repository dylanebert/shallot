// joints-filter — stage-4 gym twin: the upstream `Filter` sample
...
import goldJson from "../../../../src/standard/physics/samples/joints-filter.json";
import { register } from "../gym";
import { buildFilter, renderFilter } from "../physics-filter";
