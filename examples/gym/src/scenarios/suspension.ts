// joints-suspension — stage-4 gym twin: the tumble.js `Suspension` sample
...
import goldJson from "../../../../packages/shallot-tumble/tests/tumble/samples/joints-suspension.json";
