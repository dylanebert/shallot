// bodies-spinning-book — stage-4 gym twin: the tumble.js `SpinningBook`
...
import goldJson from "../../../../packages/shallot-tumble/tests/tumble/samples/bodies-spinning-book.json";
