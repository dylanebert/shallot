// compound-spheres — stage-4 gym twin: the tumble.js `CompoundSpheres` sample
...
import goldJson from "../../../../packages/shallot-tumble/tests/tumble/samples/compound-spheres.json";
