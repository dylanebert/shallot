// The upstream `SpinningBook` sample (`samples/src/samples/bodies.ts`) reproduced near-verbatim through
// the escape-hatch `World` API. Three flat "books" spinning in free fall (gravityScale 0), each about one
// principal axis — the one spun about its intermediate axis of inertia physicss chaotically (the
