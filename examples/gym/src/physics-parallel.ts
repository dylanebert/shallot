// The upstream `Parallel` sample (`samples/src/samples/joints.ts`) reproduced near-verbatim through the
...
// free to translate — so it barely turns while the free panel physicss.
//
...
import type { SampleUpdate } from "./physics-oracle";
import type { Overlay, SampleRender } from "./physics-overlay";
