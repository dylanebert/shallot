// The upstream `Ragdoll` sample (`samples/src/samples/ragdoll.ts`) reproduced near-verbatim through the
...
// with `determinism-falling-ragdolls`, ported into `physics-ragdoll-factory.ts`.
//
