...
import goldJsonBodyType from "../../../packages/shallot-tumble/tests/tumble/samples/bodies-body-type.json";
import goldJsonMotionLocks from "../../../packages/shallot-tumble/tests/tumble/samples/bodies-motion-locks.json";
import goldJsonSpinningBook from "../../../packages/shallot-tumble/tests/tumble/samples/bodies-spinning-book.json";
import goldJsonCharacterMover from "../../../packages/shallot-tumble/tests/tumble/samples/character-mover.json";
import goldJsonOverlapBox from "../../../packages/shallot-tumble/tests/tumble/samples/collision-overlap-box.json";
import goldJsonRayCurtain from "../../../packages/shallot-tumble/tests/tumble/samples/collision-ray-curtain.json";
import goldJsonShapeCast from "../../../packages/shallot-tumble/tests/tumble/samples/collision-shape-cast.json";
import goldJsonCompoundSimple from "../../../packages/shallot-tumble/tests/tumble/samples/compound-simple.json";
import goldJsonCompoundSpheres from "../../../packages/shallot-tumble/tests/tumble/samples/compound-spheres.json";
import goldJsonTileFloor from "../../../packages/shallot-tumble/tests/tumble/samples/compound-tile-floor.json";
import goldJsonBulletVsStack from "../../../packages/shallot-tumble/tests/tumble/samples/continuous-bullet-vs-stack.json";
import goldJsonThinWall from "../../../packages/shallot-tumble/tests/tumble/samples/continuous-thin-wall.json";
import goldJsonFallingRagdolls from "../../../packages/shallot-tumble/tests/tumble/samples/determinism-falling-ragdolls.json";
import goldJsonHitEvents from "../../../packages/shallot-tumble/tests/tumble/samples/events-hit.json";
import goldJsonJointBreak from "../../../packages/shallot-tumble/tests/tumble/samples/events-joint-break.json";
import goldJsonSensorSweep from "../../../packages/shallot-tumble/tests/tumble/samples/events-sensor-sweep.json";
import goldJsonConvexHull from "../../../packages/shallot-tumble/tests/tumble/samples/geometry-convex-hull.json";
import goldJsonConvexPrimitives from "../../../packages/shallot-tumble/tests/tumble/samples/geometry-convex-primitives.json";
import goldJsonHullReduction from "../../../packages/shallot-tumble/tests/tumble/samples/geometry-hull-reduction.json";
import goldJsonBridge from "../../../packages/shallot-tumble/tests/tumble/samples/joints-bridge.json";
import goldJsonCantilever from "../../../packages/shallot-tumble/tests/tumble/samples/joints-cantilever.json";
import goldJsonDriving from "../../../packages/shallot-tumble/tests/tumble/samples/joints-driving.json";
import goldJsonElevator from "../../../packages/shallot-tumble/tests/tumble/samples/joints-elevator.json";
import goldJsonFilter from "../../../packages/shallot-tumble/tests/tumble/samples/joints-filter.json";
import goldJsonPaddle from "../../../packages/shallot-tumble/tests/tumble/samples/joints-paddle.json";
import goldJsonParallel from "../../../packages/shallot-tumble/tests/tumble/samples/joints-parallel.json";
import goldJsonPendulum from "../../../packages/shallot-tumble/tests/tumble/samples/joints-pendulum.json";
import goldJsonRope from "../../../packages/shallot-tumble/tests/tumble/samples/joints-rope.json";
import goldJsonSuspension from "../../../packages/shallot-tumble/tests/tumble/samples/joints-suspension.json";
import goldJsonTerrain from "../../../packages/shallot-tumble/tests/tumble/samples/mesh-terrain.json";
import goldJsonTorus from "../../../packages/shallot-tumble/tests/tumble/samples/mesh-torus.json";
import goldJsonRagdoll from "../../../packages/shallot-tumble/tests/tumble/samples/ragdoll-ragdoll.json";
import goldJsonInclinedPlane from "../../../packages/shallot-tumble/tests/tumble/samples/shapes-inclined-plane.json";
import goldJsonRestitution from "../../../packages/shallot-tumble/tests/tumble/samples/shapes-restitution.json";
import goldJsonShapeSoup from "../../../packages/shallot-tumble/tests/tumble/samples/shapes-shape-soup.json";
import goldJsonArch from "../../../packages/shallot-tumble/tests/tumble/samples/stacking-arch.json";
import goldJsonBoxPyramid from "../../../packages/shallot-tumble/tests/tumble/samples/stacking-box-pyramid.json";
import goldJsonDominoes from "../../../packages/shallot-tumble/tests/tumble/samples/stacking-dominoes.json";
