// The upstream `FallingRagdolls` sample (`samples/src/samples/ragdoll.ts`) reproduced near-verbatim
...
// (`buildHuman`, shared with `ragdoll-ragdoll` via `physics-ragdoll-factory.ts`) in row-major (ix outer, iz
...
import { buildHuman } from "./physics-ragdoll-factory";
