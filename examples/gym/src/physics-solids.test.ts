...
// the wasm kernel singleton clean (the sequential-world trap, `physics-golds.test.ts`); the invariant is
...
//   bun test ./examples/gym/src/physics-solids.test.ts
...
import { beginGrab, driveGrab, type Grab, updateGrab } from "./physics-grab";
import { solidPool } from "./physics-sample";
import { collectSolids } from "./physics-solids";
