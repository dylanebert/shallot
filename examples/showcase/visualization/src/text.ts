...
// animate (the title bobs on a registered clip, the captions orbit via this system) while the glyph
...
// cos/sin on two axes) is the genuinely bespoke motion, so it's a system, not a keyframe clip.
