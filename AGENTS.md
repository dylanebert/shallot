...
- `packages/shallot/src/engine/runtime/**/*.ts`, `packages/shallot/src/engine/utils/{encode,readback}.ts`, `packages/shallot/src/standard/render/**/*.ts`, `packages/shallot/src/standard/sear/**/*.ts`, `packages/shallot/src/standard/part/**/*.ts`, `packages/shallot/src/standard/slab/**/*.ts`, `packages/shallot/src/extras/**/*.ts` → `.claude/rules/gpu.md`
