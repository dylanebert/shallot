...
- `packages/shallot/src/**/*.test.ts`, `packages/shallot/tests/**/*.ts`, `scripts/install-test.ts`, `packages/shallot/scripts/build-tooling.ts` → `.claude/rules/testing.md`
