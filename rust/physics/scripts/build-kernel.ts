...
//
// Usage: bun run rust/physics/scripts/build-kernel.ts
...
emit(
    ...
    `// Generated by rust/physics/scripts/build-kernel.ts from rust/physics/ — do not edit. Regenerate: bun run rust/physics/scripts/build-kernel.ts
// Toolchain: ${rustc()}; ${opt}.
