...
export function stripTarball(tgz: string): void {
    ...
    // The --bare arm withholds all shipped context, not just examples/: an AGENTS.md is an agent
    // doc, not code/JSDoc/product-workflow, and would weaken the context-withheld claim.
