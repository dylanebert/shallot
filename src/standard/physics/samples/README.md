# physics sample golds — source-faithful physics oracle
...
- **Sample corpus:** `upstream/samples` at commit `128a4efeb7d28024c338a4b5beaefc49d3dc4345` — the reference implementation.
...
commit above is historical provenance. `scripts/physics/gen-sample-golds.ts` is kept as the mint's recipe
