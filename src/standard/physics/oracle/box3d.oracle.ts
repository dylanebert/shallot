...
check(
    ...
    () => {
        ...
        if (manifest.bundle.schema !== "v1" && manifest.bundle.schema !== "v2" && manifest.bundle.schema !== "v3" && manifest.bundle.schema !== "v4" && manifest.bundle.schema !== "v5") throw new Error("unsupported oracle schema");
