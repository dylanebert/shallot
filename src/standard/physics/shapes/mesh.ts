...
// query's triangle-visit order are load-bearing for bit-exactness. fround discipline (every f32 result rounds through Math.fround, keeping bit-exact f32 parity).
