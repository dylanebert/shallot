...
// The ragdoll (shared/human.c CreateHuman): 14 capsule bones, transcribed as f32 literals in fixtures/human.json. Bone order
...
const HUMAN_BONES = loadFixture<BoneSpec[]>("human");
 ...
 */
export function buildLegacyScene(
    scene: string,
    enableSleep: boolean,
