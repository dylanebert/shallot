// Destination: shallot-ascii; owner: ascii-extraction.md.
...
// glaze's postfx chain by default (`transitional/glaze`'s own zero-config shape). Each sink sizes the grid
