 ...
 * flat cell — reproduced directly against the ascii recipe at a yaw showing three
 ...
 * inside the luma band the recipe's faces occupy in the tier-0 dump (the ascii recipe
