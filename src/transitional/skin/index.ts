// Destination: shallot-gltf (experimental repository); owner: gltf-extraction.md.
...
// procedural (a physics ragdoll, a scripted driver) or an importer (`transitional/gltf` converts a glTF rig into
...
// these (`transitional/gltf`'s `skin-live` PBR trio is the worked case). The author happy path (`SkinPlugin` /
