...
//     hand-authored: rendered and measured by `scripts/generate/generate-ramp.ts`, committed in `ramp-table.ts`,
//     and reproduced by `ramp-table.test.ts` against the cells face (`the `cells-face` asset`) the generator
//     reads.
 ...
 *  from {@link CELL_FILL_GLYPHS} (excluded from its coverage measurement, `scripts/generate/generate-ramp.ts`)
 ...
 *  data (`scripts/generate/generate-ramp.ts` / `ramp-table.ts`), not hand-authored. */
