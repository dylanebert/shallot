...
import { type Font, parseFont } from "../text/font";
...
const OUTPUT_URL = new URL("./ramp-table.ts", import.meta.url);
...
// scripts/generate-ramp.ts\` from the shallot repo root and review the diff.
