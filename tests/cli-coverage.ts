...
export const CLI_COVERAGE: readonly CoverageRow[] = [
    ...
    },
    {
        ...
        reason:
            ...
            "./tests/setup.ts -e 'console.log(\"GPUColorWrite\" in globalThis)'` prints " +
    ...
    {
        file: "src/extras/outline/index.ts",
        arm: "tier",
        reason:
    ...
    {
        file: "src/extras/outline/passes.ts",
        arm: "unit",
        reason:
    ...
    },
    {
        ...
        reason:
            ...
            "plus resolved-path pair, discoverScenes and " +
