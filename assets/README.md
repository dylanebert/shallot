...
The checked-in bytes have MD5 `3d12b91dc3e06267b7eaead855a9276f`. `font.ttf` remains the Outfit fixture used by the text scenario and retains its original bytes.
