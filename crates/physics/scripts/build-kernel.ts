...
// src/transitional/physics/kernel/. Inlining (not a separate .wasm asset) keeps the engine pure JS — no
...
const engineDir = resolve(pkgRoot, "src/transitional/physics/kernel");
